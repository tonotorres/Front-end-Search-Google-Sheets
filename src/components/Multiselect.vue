...
import listenOnRootMixin from "bootstrap-vue/es/mixins/listen-on-root";
import clickoutMixin from "bootstrap-vue/es/mixins/clickout";
...
$multy-select-color: #3191CC !important !default;
...
$multy-select-indicator-color: #3191CC !default;
$multy-select-indicator: str-replace(
    url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3E%3Cpath fill='#3191CC' d='M2 0L0 2h4zm0 5L0 3h4z'/%3E%3C/svg%3E"),
    "#",
    "%23"
  )
  !default;
...
.multiselect {
  ...
  .multiselect-tags {
    ...
    color: #3F98CF !important;
    vertical-align: middle;
    background: #3191CC !important;
...
@mixin multiselect-tag-variant($bg) {
  span {
    color: #3191CC !important;
    background-color: #3191CC !important;
  }
  .multiselect-tag-remove {
    color: color-yiq($bg);
    background-color: #3191CC !important;
...
.multiselect-tag-default {
  @include multiselect-tag-variant(#0078C1);
}
...
.multiselect-option {
  ...
  &:active {
    ...
    text-decoration: none;
    @include gradient-bg(#3191CC !important);
  }
